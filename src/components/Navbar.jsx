    ...
    return (
        ...
        <nav className='navbar'> 
            <div className='navbar-container'> 
                <HashLink to='/#top' scroll={el => offset(el, 0)} className='navbar-logo' onClick={closeMobileMenu}> 
                ...
                <ul className={click ? 'nav-menu active' : 'nav-menu' }>
                    <li className='nav-item'>
                        <HashLink to='/#home' scroll={el => offset(el, 80)} className='nav-links' onClick={closeMobileMenu}>
                            HOME
                        </HashLink>
                    </li>
                    <li className='nav-item'>
                        <HashLink to='/#services' scroll={el => offset(el, 40)} className='nav-links' onClick={closeMobileMenu}>
                            SERVICES
                        </HashLink>
                    </li>
                    <li className='nav-item'>
                        <HashLink to='/#contact-us' scroll={el => offset(el, 1000)} className='nav-links' onClick={closeMobileMenu}>
                            MAP
                        </HashLink>
                    </li>
                    <li className='nav-item'>
                        <HashLink to='/#contact-us' scroll={el => offset(el, 5)} className='nav-links' onClick={closeMobileMenu}>
                            CONTACT US
                        </HashLink>
                    </li>
                    <li className='nav-item'>
