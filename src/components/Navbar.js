    ...
    <>
      <nav className='navbar'>
        <div className='navbar-container'>
          <Link to='/#top' scroll={el => offset(el, 0)} className='navbar-logo' onClick={closeMobileMenu} >
          ...
          <ul className={click ? 'nav-menu active' : 'nav-menu'}>
            <li className='nav-item'>
              <Link to='/#home' scroll={el => offset(el, 80)} className='nav-links' onClick={closeMobileMenu}>
                HOME
              </Link>
            </li>
            <li className='nav-item'>
              <Link
                to='/#services' scroll={el => offset(el, 40)}
                className='nav-links'
            ...
            <li className='nav-item'>
              <Link
                to='/#contact-us' scroll={el => offset(el, 1000)}
                className='nav-links'
                onClick={closeMobileMenu}
              >
                MAP
            ...
            <li className='nav-item'>
              <Link
                to='/#contact-us' scroll={el => offset(el, 5)}
                className='nav-links'
                onClick={closeMobileMenu}
              >
                CONTACT US
